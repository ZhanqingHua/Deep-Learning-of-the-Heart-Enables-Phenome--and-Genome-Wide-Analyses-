...
phenoCol="X48_LeastAxisLength_all"
wdir="/data/circ_ukb/AHua/project/GWAS/regenie/height/metaanalysis"
metal_bin="/data/circ_ukb/AHua/METAL/build/metal/metal"
input1="/data/circ_ukb/AHua/project/GWAS/regenie/height/step2/height_GSA_53K_${phenoCol}.regenie"
input2="/data/circ_ukb/AHua/project/GWAS/regenie/height/step2/MEG_12/height_MEG_12K_${phenoCol}.regenie"
